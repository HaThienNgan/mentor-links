 ...
 * Use the {@link newCourseFragment#newInstance} factory method to
...
public class newCourseFragment extends Fragment {
    ...
    String APIUrl = "https://alpha.mentorlinks.net/MLSOAP/searchSOAP.php?t=getNewCourse";
           ...
           mCourseList = new ArrayList<>();
            ...
            try {
                ...
                for(int i = 0; i < jsonArray.length(); i++){
                    ...
                    String ratingval = rootObject.getString("ratingval");
                    int ratingnum = rootObject.getInt("ratingnum");

                    mCourseList.add(new Course("", "", image_Title, "", introduction, title, mentorimage, "", mentorname, fee, dateendregister, "", ratingval, ratingnum, "", "c"  ));
                    CourseAdapter courseAdapter = new CourseAdapter(getContext(), mCourseList);
                    mViewPager2.setAdapter(courseAdapter);
